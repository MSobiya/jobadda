<html>
<body>
<head><center><h1> HARDWARE QUESTION</h1></center></head>
<form action="hardware_result.php" method="post">
<?php
...
$links=array('Which 1 of these lists contains only Java programming language keywords?<br><br> &nbsp;&nbsp;&nbsp;&nbsp;
				...
				'11)class X implements Runnable 
{ 
...
Which of the following line of code is suitable to start a thread ? <br><br>&nbsp;&nbsp;&nbsp;&nbsp; 

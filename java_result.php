<html>
<body>
<head><center><h1> JAVA QUIZ RESULT</h1></center></head>
<p>&nbsp;&nbsp;&nbsp;&nbsp;</p>
<p>&nbsp;&nbsp;&nbsp;&nbsp;</p>
...
// the only answered 
	...
	if ($q1 == "B) goto, instanceof, native, finally, default, throws") {
	  	$ans1 =  "<p>correct</p>";
	...
	// }
		...
		if ($q7 == "A)	boolean b3 = false;") {
		$ans7 =  "<p>correct</p>";
		$question7 = "Which one is a valid declaration of a boolean? &nbsp;&nbsp;&nbsp; ";
	 	$score7 =1;}
	...
	if ($q8 == "A)	String s1 = null;") {
		$ans8 = "<p>correct</p>";
		$question8 = "Which is a valid declarations of a String? &nbsp;&nbsp;&nbsp; ";
	 	$score8 =1;}
	...
	if ($q9 == "D)	0 to 65535") {
		$ans9 =  "<p>correct</p>";
		$question9 = "What is the numerical range of a char? &nbsp;&nbsp;&nbsp; ";
	 	$score9 =1;}
	...
	if ($q10 == "B)	start();") {
		$ans10 = "<p>correct</p>";
		$question10 = "What is the name of the method used to start a thread execution? &nbsp;&nbsp;&nbsp; ";
	 	$score10 =1;}
	...
	if ($q13 == "C)	X run = new X(); Thread t = new Thread(run); t.start();") {
		$ans13 =  "<p>correct</p>";
		$question13 = "class X implements Runnable {    public static void main(String args[])    {        /* Missing code? */    }    public void run() {} } Which of the following line of code is suitable to start a thread ? &nbsp;&nbsp;&nbsp; ";
	 	$score13 =1;}
	 ...
	 //  	$score13 =0; 
	// }
		if ($q14 == "C)	Calling notify() method on an object.") {
		$ans14 =  "<p>correct</p>";
		$question14 = "Which cannot directly cause a thread to stop executing? &nbsp;&nbsp;&nbsp; ";
	 	$score14 =1;}
	...
	if ($q15== "A)	Finally") {
		$ans15 =  "<p>correct</p>";
		$question15 = "What will be the output of the program? public class Foo {    public static void main(String[] args)    {        try
	...
	if ($q16== "C)	protected") {
		$ans16 = "<p>correct</p>";
		$question16 = "You want subclasses in any package to have access to members of a superclass. Which is the most restrictive access that accomplishes this objective? &nbsp;&nbsp;&nbsp; ";
	 	$score16 =1;}
	...
	if ($q18== "C)	It can extend exactly one class or implement exactly one interface.") {
		$ans18 =  "<p>correct</p>";
		$question18 = "Which is true about an anonymous inner class?  &nbsp;&nbsp;&nbsp; ";
	 	$score18 =1;}
	...
	if ($q19== "166 MHz to 4 GHz") {
		$ans19 =  "<p>correct</p>";
		$question19 = "Which declaration of the main method below would allow a class to be started as a standalone program.  &nbsp;&nbsp;&nbsp; ";
	 	$score19 =1;}
	...
	if ($q20== "B) public static void main(String args[])") {
		$ans20 =  "<p>correct</p>";
		$question20 = "Which of the following are Java keywords?  &nbsp;&nbsp;&nbsp; ";
	 	$score20 =1;}
	...
	if ($q21== "B) Execute class file") {
		$ans21 = "<p>correct</p>";
		$question21 = "Java Interpreter is used for which purpose?  &nbsp;&nbsp;&nbsp; ";
	 	$score21 =1;}

...
$sql = "insert into resume values ('$uname','$r_name1','$r_head1','$r_loc1','$r_web1','$r_sal1','$r_age1','$r_phn1','$r_mail1','$r_fb1','$r_tw1','$r_g1','$r_git1','$r_deg1','$r_maj1','$r_ins1','$r_doa1','$r_dol1','$r_cmp1','$r_pos1','$r_doaC1','$r_exp1')";
...
$sql = "update resume set r_name1 = '$r_name1' , r_head1 = '$r_head1', r_loc1 = '$r_loc1', r_web1 = '$r_web1', r_sal1 = '$r_sal1', r_age1 = '$r_age1', r_phn1 = '$r_phn1', r_mail1 = '$r_mail1', r_fb1 = '$r_fb1', r_tw1 = '$r_tw1', r_g1 = '$r_g1', r_git1 = '$r_git1', r_deg1 = '$r_deg1', r_maj1  = '$r_maj1', r_ins1 = '$r_ins1', r_doa1 = '$r_doa1', r_dol1 = '$r_dol1', r_cmp1  = '$r_cmp1', r_pos1 = '$r_pos1', r_doaC1 = '$r_doaC1', r_exp1 = '$r_exp1' where uname = '$uname' ";
echo "<hr>";

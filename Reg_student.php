         ...
         <div class="form-group">
          ...
          <div class="form-group">
            <div class="input-group">
              ...
              <input type="text" class="form-control" placeholder="Your email address" name="c_email" required>
            </div>
          </div>
          ...
          <div class="form-group">
            <div class="input-group">
              <span class="input-group-addon"><i class="ti-unlock"></i></span>
              <input type="password" name="c_pwd" class="form-control" placeholder="Re Enter Password" required>
            </div>
          </div>

          <button class="btn btn-primary btn-block" name="applicant_db" type="submit">Register</button>
